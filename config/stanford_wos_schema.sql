...
COMMENT ON COLUMN  wos_grants.grant_info_language IS 'Language of grant information';
COMMENT ON COLUMN  wos_grants.grant_agency IS 'Grant agency';
COMMENT ON COLUMN  wos_grants.grant_agency_language IS 'Language of grant agency';
...
COMMENT ON COLUMN  wos_keywords.keyword_language IS 'Language of keyword';
...
COMMENT ON COLUMN  wos_abstracts.abstract_language IS 'Language of abstract';
...
COMMENT ON COLUMN  wos_keywords_plus.keyword_language IS 'Language of keyword';
...
GRANT SELECT ON ALL TABLES IN SCHEMA  TO wos_admin;
